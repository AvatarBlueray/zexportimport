      ...
      IF sy-subrc = 0.
        TRY.
            IF head+0(1) = 'Y' OR head+0(1) = 'Z'
              OR head+0(5) = '/NGZ/' OR head+0(7) = '/RUSAL/' OR head+0(5) = '/RUL/'
      ...
      IF NOT customeronly IS INITIAL.
        TRY.
            IF watokens-str+0(1) = 'Y' OR watokens-str+0(1) = 'Z'
              OR watokens-str+0(5) = '/NGZ/' OR watokens-str+0(7) = '/RUSAL/' OR watokens-str+0(5) = '/RUL/'
...
*    loop at rangeprogram into warangeprogram.
...
*     Select all programs
      SELECT a~progname
             ...
             WHERE a~progname IN rangeprogram
               ...
               AND ( a~subc = '1' OR a~subc = 'M' OR a~subc = 'S' OR a~subc = 'I' )
               AND b~pgmid = 'R3TR'
               AND b~object = 'PROG'
               AND b~devclass IN solocpackage.
      ...
      SELECT a~progname
             ...
             WHERE a~progname IN rangeprogram
               AND ( a~progname LIKE altcustomernamerange
                     ...
                     OR a~progname LIKE 'SAPMZ%'
                     OR a~progname LIKE 'SAPMY%')
               AND ( a~subc = '1' OR a~subc = 'M' OR a~subc = 'S' OR subc = 'I' )
               AND ( a~cnam IN rangeauthor OR a~unam IN rangeauthor )
               AND b~pgmid = 'R3TR'
               AND b~object = 'PROG'
               AND b~devclass IN solocpackage.
    ...
    IF custnamerange <> '^'.
      ...
      SELECT progname
             ...
             WHERE progname  IN rangeprogram
               ...
               AND ( subc = '1' OR subc = 'M' OR subc = 'S' OR subc = 'I' )
...
* Read the program code from the textpool.
  ...
  LOOP AT itokens.
    IF NOT customeronly IS INITIAL.
      TRY.
          IF ( itokens-str+0(1) <> 'Y' OR itokens-str+0(1) <> 'Z'
            OR itokens-str+0(5) = '/NGZ/' OR itokens-str+0(7) = '/RUSAL/' OR itokens-str+0(5) = '/RUL/'
...
FORM findmainfunctioninclude USING value(programname)
                                   ...
                                   value(functionincludeno)
                                         functionincludename.
  IF functiongroup(5) = '/NGZ/'.
    CONCATENATE functiongroup(5) 'L' functiongroup+5(21) 'U'
                    functionincludeno
                    INTO functionincludename.
  ELSEIF functiongroup(5) = '/RUL/'.
    CONCATENATE functiongroup(5) 'L' functiongroup+5(21) 'U'
                    functionincludeno
                    INTO functionincludename.
  ELSEIF functiongroup(7) = '/RUSAL/'.
    CONCATENATE functiongroup(7) 'L' functiongroup+7(19) 'U'
                    functionincludeno
                    INTO functionincludename.
  ELSE.
...
FORM findfunctiontopinclude USING value(programname)
  ...
  IF functiongroup(5) = '/NGZ/'.
    CONCATENATE functiongroup(5) 'L' functiongroup+5(21) 'TOP'
                    INTO topincludename.
  ELSEIF functiongroup(5) = '/RUL/'.
    CONCATENATE functiongroup(5) 'L' functiongroup+5(21) 'TOP'
                    INTO topincludename.
  ELSEIF functiongroup(7) = '/RUSAL/'.
    CONCATENATE functiongroup(7) 'L' functiongroup+7(19) 'TOP'
                    INTO topincludename.
  ELSE.
...
*         Are we only to download SAP dictionary structures.
          IF NOT customeronly IS INITIAL.
            TRY.
                IF waline+0(1) = 'Y' OR waline+0(1) = 'Z'
                  OR waline+0(5) = '/NGZ/' OR waline+0(7) = '/RUSAL/' OR waline+0(5) = '/RUL/'
...
*             Function name is now in head
              ...
              TRY.
                  IF head+0(1) = 'Y' OR head+0(1) = 'Z' OR head+0(1) = 'y' OR head+0(1) = 'z'
                  OR head+0(5) = '/NGZ/' OR head+0(7) = '/RUSAL/' OR head+0(5) = '/RUL/'
                    OR head CS customernamerange.
        ...
        IF wacontent CS include OR wacontent CS lowinclude.
          ...
          TRY.
              IF ( tail+0(1) = 'Y' OR tail+0(1) = 'Z' OR tail+0(1) = 'y' OR tail+0(1) = 'z'
                  OR tail+0(5) = '/NGZ/' OR tail+0(7) = '/RUSAL/' OR tail+0(5) = '/RUL/'
                OR tail CS customernamerange OR tail+0(2) = 'mz' OR tail+0(2) = 'MZ' )
